  ...
  const mockOrders: Order[] = [
    {
      ...
      note: 'Клиент просит срочное исправление.',
      package_cost: 1500,
      order_cost: 2200,
      priority: 'high',
      status: 'in_progress',
    ...
    },
    {
      ...
      note: 'Ожидает согласования бюджета.',
      package_cost: 3000,
      order_cost: 4700,
      priority: 'medium',
      status: 'new',
    ...
    },
    {
      ...
      note: 'Работа завершена и передана на проверку.',
      package_cost: 5000,
      order_cost: 7500,
      priority: 'low',
      status: 'completed',
    ...
    },
    {
      ...
      note: 'Нужно согласовать с backend-командой.',
      package_cost: 2600,
      order_cost: 4100,
      priority: 'high',
      status: 'in_progress',
    ...
    },
    {
      ...
      note: 'Проект остановлен по решению заказчика.',
      package_cost: 1200,
      order_cost: 1800,
      priority: 'medium',
      status: 'cancelled',
